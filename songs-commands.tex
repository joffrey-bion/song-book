...
\newenvironmentx{Song}[6][1,3,5,6]{%
	...
	\songTitle{#2}
	\index{\defaut{#1}{#2}@ #2}          % index the title
	\index{\defaut{#3}{#4}@ \textbf{#4}} % index the artist
	\index{\defaut{#6}{#5}@ \textbf{#5}} % index the original artist
	\begin{center}
}{%
	\end{center}
}
...
% Chords grids macros (a utiliser dans l'ordre)
...
\newcommand{\demidim}{\mineur\sept\quintedim} % 1 3m 5b 7m note aussi $\varnothing$
